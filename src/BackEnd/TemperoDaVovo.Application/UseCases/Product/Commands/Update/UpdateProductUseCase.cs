...
public class UpdateProductUseCase : IUpdateProductUseCase
{
    ...
    public UpdateProductUseCase(IProductReadOnlyRepository productReadOnlyRepository, IProductWriteOnlyRepository productWriteOnlyRepository, IUnitOfWork unitOfWork, IAuthorizationService authorizationService)
    {
    ...
    public async Task ExecuteAsync(UpdateProductRequestJson request, Guid productId)
    {
